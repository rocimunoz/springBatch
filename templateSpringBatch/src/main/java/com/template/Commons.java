...
public class Commons {
    ...
    public static String VERSION = "CargadorInventarioCSD v01.00 (29/10/2015)";
//    public final static String LOG_CONFIG = "config/viesgo/cfg/log4j.properties";
    // Ubicacion de la configuracion de los owners de las sentencias sql
    // (fichero properties)   
    public final static String INI_CONFIG = "config/viesgo/cfg/prj.properties";
